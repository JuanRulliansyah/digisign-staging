        ...
        <>
            ...
            >
                ...
                <table className="items-center w-full bg-transparent border-collapse">
                    ...
                    <tbody>
                    {props.kyc && props.kyc.map((kyc, index) => {
                        return(
                            <tr>
                                ...
                                >
                                    Request KYC on {moment(kyc.created_at).format('MMM. DD, YYYY')}
                                </span>
                                </th>
